...
<section>
    <section class="team-page-section">
        <div class="container">
                ...
                <div class="team-block col-lg-4 col-md-6 col-sm-12">
                    <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                        <ul class="social-icons">
                            <li><a href="https://github.com/JRoz89" target="_blank"><i class="fab fa-github"></i></a></li>
                            <li><a href="https://www.linkedin.com/in/josh-roznowski/" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                        </ul>
                    <div class="image">
            ...
            <div class="team-block col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                    <ul class="social-icons">
                        <li><a href="https://github.com/etracht" target="_blank"><i class="fab fa-github"></i></a></li>
                        <li><a href="https://www.linkedin.com/in/etracht/" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                    </ul>
                    <div class="image">
            ...
            <div class="team-block col-lg-4 col-md-6 col-sm-12">
                <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                    <ul class="social-icons">
                      <li><a href="https://github.com/YaozeZ" target="_blank"><i class="fab fa-github"></i></a></li>
                      <li><a href="https://www.linkedin.com/in/yaoze-zhang-58647120a/" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
                  </ul>
                  <div class="image">
        ...
        <div class="team-block col-lg-4 col-md-6 col-sm-12">
            <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
                <ul class="social-icons">
                 <li><a href="https://github.com/DylanBerquist" target="_blank"><i class="fab fa-github"></i></a></li>
                 <li><a href="https://www.linkedin.com/in/dylan-berquist-004b841a0/" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
             </ul>
             <div class="image">
            ...
            <div class="lower-content">
                ...
                <div class="designation"> Full Stack Developer </div>
                <p style ="font-size: 12px;">I am a passionate computer science major at Eastern Michigan University. I love learning about all things related to technology. I also enjoy playing my bass guitar, playing chess, and spending time with friends. My favorite thing recently has been improving my physical fitness, and I am proud to say that I’ve lost over 90lbs since March 2020. </p>
            </div>
        </div>
    </div>
    <!-- Team Block -->
    <div class="team-block col-lg-4 col-md-6 col-sm-12">
        <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
            <ul class="social-icons">
                <li><a href="https://github.com/JonathanNemchak" target="_blank"><i class="fab fa-github"></i></a></li>
                <li><a href="https://www.linkedin.com/in/jonathan-nemchak-7977aa20a/" target="_blank"><i class="fab fa-linkedin-in"></i></a></li>
            </ul>
            <div class="image">
    ...
    <div class="team-block col-lg-4 col-md-6 col-sm-12">
        <div class="inner-box wow fadeInLeft" data-wow-delay="0ms" data-wow-duration="1500ms">
            <ul class="social-icons">
             <li><a href="https://github.com/alighaleb1" target="_blank"><i class="fab fa-github"></i></a></li>
        ...
        <div class="lower-content">
            ...
            <h3><a href="#">Ali</a></h3>
            <div class="designation">Front End Developer </div>
            <p style ="font-size: 12px;"> I am the Front-back developer of this site. I enjoy playing sports , helping others, and achieving anything I set my mind to. My favorite thing to do is to learn new things everyday because everyday is a chance to learn something new. <br> <br><br></p>
        </div>
    </div>
</div>
<!-- Team Block -->
<div class="team-block col-lg-4 col-md-6 col-sm-12">
    ...
    <div class="lower-content">
        ...
        <div class="designation">Front End Developer </div>
        <p style ="font-size: 12px;"> I am the Front-back developer for AthletiSize. interests, hobbies, I like learning  about Sciences, Graphic and Interior Design. I like  to spend time  with my family ,cooking and  playing tennis . "quote": Push yourself, because no one else is going to do it for you.
            <br> <br></p>
    </div>
</div>
</div>
